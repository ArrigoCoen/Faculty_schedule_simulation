\section{Resultados del Algoritmo Genético} \label{Sec_Resultados_AG}
...
%\hline 
% \textbf{Generaciones} & \textbf{Población} & \textbf{Minutos} & \textbf{Horas}\\ \hline
% 3 & 5 & 39.52 & 0.65 \\ \hline
% 3 & 15 & 116.99 & 1.94 \\ \hline
% 6 & 5 & 96.63 & 1.61 \\ \hline
% 6 & 10 & 176.08 & 2.93 \\ \hline
% 8 & 8 & 215.22 & 3.58 \\ \hline
% 10 & 5 & 156.97 & 2.61 \\ \hline
% 10 & 10 & 394.80 & 6.58 \\ \hline
%\end{tabular}
...
Cabe mencionar que en estos tiempos no se toma en cuenta la simulación del esqueleto ni las solicitudes de los profesores. La primera se tarda alrededor de 12 minutos cuando se simulan 10 matrices de demanda de alumnos. La simulación de las solicitudes de profesores tarda apróximadamente 8 segundos. Por lo cual, en el escenario más tardado, el tiempo total para encontrar una buena asignación es menor a 7 horas. %Por lo que los tiempos totales son prácticamente iguales.
...
\begin{figure}[h]
\centering
\includegraphics[scale = 0.67]{boxplot_num_genes_g08_n08_m004_U510.pdf} %width=\textwidth
...
Sabemos que la asignación final es el mejor elemento de la última generación. En la \tablename{~\ref{submatAsigFinal}} presentamos una submatriz de una asignación final. La matriz completa se puede ver en el Apéndice \ref{Ej_AsigFinal}. Cabe aclarar que los datos se ordenaron con respecto a la materia (en orden alfabético) y por hora (de menor a mayor). Se pueden ver más ejemplos de asignaciones finales en el repositorio \url{https://github.com/ArrigoCoen/Faculty_schedule_simulation}.
