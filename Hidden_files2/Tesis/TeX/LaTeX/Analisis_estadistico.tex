...
Definimos a una serie de tiempo como una secuencia de observaciones $X_{t}$ ordenadas cronológicamente. Los datos al tiempo presente dependen de las observaciones anteriores, es decir existe una depencia de $X_{t}$ con $\{X_{t-1}, X_{t-2}, X_{t-3}, \ldots, X_{2}, X_{1}, X_{0}\}$. %$\{X_{t-1}, X_{t-2}, X_{t-3}, \ldots, X_{2}, X_{1}, X_{0}, \ldots\}$.
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{descomposicion_ts_total_alumnos.pdf} %scale = 0.75
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{prom_alum_total_x_sem_ts.pdf} %scale = 0.72
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.95]{cox_stuart_test_randomness} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.95]{cox_stuart_test_increasing_trend} %width=\textwidth
...
\begin{figure}[h]
\centering
\includegraphics[scale = 0.75]{num_alum_total_x_sem_barplot} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.95]{qs_test_seasonality} %width=\textwidth
...
El término homocedasticidad se utiliza cuando los datos tienen varianza constante. En nuestro caso, nos interesa probar que el número de alumnos totales tiene varianza constante. Ésto para comprobar que el modelo de estacionalidad adecuado para nuestros datos es el aditivo.
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.9]{jarque_bera_test_normality} %width=\textwidth
...
En la \figurename{~\ref{bpTest_homocedasticidad}} se puede ver el resultado de la prueba. Vemos que \textit{p-value} $ = 0.82 > 0.01 = \alpha$ por lo tanto no se rechaza $H_{0}$, entonces la varianza de los datos es constante.


\begin{figure}[H]
\centering
\includegraphics[scale = 0.9]{bp_test_homocedasticidad} %width=\textwidth
...
\begin{figure}[h]
\centering
\includegraphics[scale = 0.65]{num_alum_matu_vesp_ts.pdf} %width=\textwidth
...
También podemos observar que en Actuaría (línea azul) y en Matemáticas Aplicadas (línea rosa) hay una mayor concentración en los grupos que tienen aproximadamente entre 50 y 75 alumnos, que en Matemáticas o en Ciencias de la Computación.
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.66]{histogramas_FR_num_alum_x_carrera.pdf} %width=\textwidth
...
En la prueba se rechaza $H_{0}$ cuando $D_{n} > D_{n}^{1-\alpha}$. Donde $D_{n}^{1-\alpha}$ nos indica el valor en donde inicia la región de rechazo para un nivel de significancia de $\alpha$ y $n$ es el número de datos de la muestra. Tomamos como hipótesis nula $H_{0}: X$ y $Y$ tienen la misma distribución.
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.7]{histograma_FR_prueba_KS.pdf} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.7]{num_prom_gpos_x_hora_barplot.pdf} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.7]{prom_alum_x_hora_barplot.pdf} %width=\textwidth
