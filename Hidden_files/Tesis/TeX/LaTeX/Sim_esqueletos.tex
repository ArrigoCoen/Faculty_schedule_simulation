...
En la \figurename{~\ref{hist_wait_esq_fin}}, se puede ver el histograma con todos los datos de los esqueletos simulados. La línea azul representa la distribución ajustada por el modelo final de mezcla de normales, \textit{mixmdl\_esqueleto}. Se puede ver que con dicha distribución en las horas del turno matutino se van a simular más grupos que en las horas del turno vespertino. En este caso, los valores de $\mu$ y $\sigma$ son:

\begin{itemize}
\item[-] $\mu = \{7.56, 9.92, 13.01, 18.21 \}$ %$\mu = \{7.560515, 9.924546, 13.015799, 18.216268 \}$

\item[-] $\sigma = \{0.53, 0.72, 2.19, 1.60 \}$ %$\sigma = \{0.5352610, 0.7244501, 2.1976618, 1.6099464 \}$
\end{itemize}
