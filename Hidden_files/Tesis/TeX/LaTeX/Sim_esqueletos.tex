...
\item Simular un esqueleto inicial con la función \textit{gen\_esqueleto}. Los pasos de esta función se pueden ver en la Subsección \ref{subsec_gen_esqueleto}.
...
\item Definir el modelo final \textit{mixmdl\_esqueleto} con la función en \textit{R}:
...
\caption[\textit{Histograma con  todos los datos de los esqueletos simulados}]{\textit{Se muestra el histograma con  todos los datos de los esqueletos simulados. La línea azul representa la distribución ajustada por el modelo final.}}\label{hist_wait_esq_fin}
\end{figure}
