...
\begin{figure}[H]
\centering
\subfigure[\textit{Plan de estudios posterior}]{\includegraphics[width=10cm]{InfoRepetida_A_1}} %%Ping\"uino %%[angle=30]
	\subfigure[\textit{Plan de estudios correspondiente}]{\includegraphics[width=10cm]{InfoRepetida_A_2}}
...
\begin{figure}[H]
	\centering
	\subfigure[\textit{Matemáticas: 1983}]{\includegraphics[width=10cm]{InfoRepetida_B_1}} %%Ping\"uino %%[angle=30]
	\subfigure[\textit{Actuaría: 2015}]{\includegraphics[width=10cm]{InfoRepetida_B_2}}
