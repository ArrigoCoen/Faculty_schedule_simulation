...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.5]{histograma_FR_D-E_x_materia} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.5]{histograma_FR_D-E_D_x_materia} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 1]{error_rel_mate_para_ciencias_app} %width=\textwidth
