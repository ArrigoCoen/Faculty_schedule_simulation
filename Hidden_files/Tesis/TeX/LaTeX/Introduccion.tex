...
\begin{figure}[h]
\centering
\includegraphics[scale = 0.65]{num_alum_x_turno_Proba_I.pdf} %width=\textwidth
...
\begin{figure}[h]
\centering
\includegraphics[scale = 0.65]{histograma_FR_num_alum_x_turno_Proba_I.pdf} %width=\textwidth
