...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.55]{num_alum_sem_par_impar_Proba_I.pdf} %width=\textwidth
\caption[\textit{Número de alumnos totales por semestres pares e impares: Probabilidad I}]{\textit{Número de alumnos totales por semestres pares e impares de Probabilidad I: Esta figura muestra las series de tiempo del número de alumnos de semestres pares e impares. Se puede observar que el número de alumnos de semestres impares es siempre mayor al de semestres pares.}}\label{ParImparProbaI}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{num_alum_x_turno_Proba_I.pdf} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{histograma_FR_num_alum_x_turno_Proba_I.pdf} %width=\textwidth
