...
%\textbf{Esqueleto:} Matriz de 15 renglones con las horas $(7-8, 8-9, \ldots, 21-22)$ y tantas columnas como materias se tienen. En la entrada $(i,j)$ se tiene el el número de grupos simulados para la hora $i$ de la materia $j$.
