...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.8]{density_function_default} %width=\textwidth
%\url{https://www.rdocumentation.org/packages/stats/versions/3.6.2/topics/density}
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.55]{num_alum_x_turno_Proba_I.pdf} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.6]{histograma_FR_num_alum_x_turno_Proba_I.pdf} %width=\textwidth
