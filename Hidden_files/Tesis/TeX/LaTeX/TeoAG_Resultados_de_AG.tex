...
Por estas razones el algoritmo asigna alrededor del $60\%$ de los grupos simulados. Para aumentar este porcentaje, se pueden definir manualmente grupos difíciles de asignar con el AG, en el archivo de excel definido en el paso \ref{paso_cero} del algoritmo. Pueden ser materias optativas u obligatorias. Dado que se elimina la información en las solicitudes antes de realizar el AG, no se tienen grupos repetidos en la última asignación.
