...
En la simulación de solicitudes se eligen materias y horarios con respecto a los profesores. Definimos la matriz \textit{mat\_nom\_prof\_total}, con 2 columnas. En ella guardamos información de cada profesor.
...
\caption[\textit{Vector de profesores de tiempo completo}]{\textit{Se observan las primeras 20 entradas del vector obtenido con la aplicación SelectorGadget al dar click en el nombre de un profesor de tiempo completo.}}\label{profTC_sinLimpiar}
\end{figure}
...
Finalmente obtuvimos un vector con 1129 nombres de los profesores de asignatura. Guardamos los nombres en la matriz \textit{mat\_nom\_prof\_total}. Dicha matriz contiene la información de 1223 profesores.
