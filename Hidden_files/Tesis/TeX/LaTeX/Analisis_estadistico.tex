...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.6]{histogramas_FA_num_alum_x_carrera.pdf} %width=\textwidth
...
\begin{figure}[H]
\centering
\includegraphics[scale = 0.6]{histogramas_FR_num_alum_x_carrera.pdf} %width=\textwidth
