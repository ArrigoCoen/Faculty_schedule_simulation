...
Recordemos que URL por sus siglas en inglés significa \textit{Uniform Resource Locator}. Cada URL corresponde a una dirección de una página de internet. %Se tiene una URL por cada página web.
