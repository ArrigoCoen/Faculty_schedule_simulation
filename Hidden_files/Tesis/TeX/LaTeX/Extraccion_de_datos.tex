...
Las siglas en inglés URL significan \textit{Uniform Resource Locator}. Cada URL corresponde a una dirección de una página de internet. %Se tiene una URL por cada página web.
