...
source("Programas/Figuras PDF/fig_histograma_num_alum_x_gpo_x_sem/histograma_num_alum_x_gpo_x_sem.R")
...
source("Programas/Figuras PDF/fig_densidad_num_alum_x_gpo_x_sem/densidad_num_alum_x_gpo_x_sem.R")
