...
legend(20163,10000,c("Turno matutino",
                   "Turno vespertino"),bty = "n",
       col=c(param_graficas$col1_linea,param_graficas$col2_linea),
       pch=c("o","o"),lty=c(1,1))#,cex=1.1

# manipulate(legend(Xcoord,Ycoord,c("Turno matutino","Turno vespertino"),bty = "n",
#                   col=c(param_graficas$col1_linea,param_graficas$col2_linea),
#                   pch=c("o","o"),lty=c(1,1)),
#            Xcoord = slider(20080, 20200, step=5, initial = 20185),
#            Ycoord = slider(0, 25000, step=1000, initial = 10000))
