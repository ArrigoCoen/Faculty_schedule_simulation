...
#' las calificaciones de la metodología D.
##########################################################################
...
#' Se cargan los datos
load("Programas/Figuras PDF/fig_matplot_calif_metodo_D/mat_calif_D.RData")
...
matplot(mat_calif_D, type = "l",main = "Metodología D",xlab = "Iteraciones",
        ylab = "Calificación",ylim = c(-6,0.5))


# Se guarda la imagen -----------------------------------------------------
nom_plot <- "matplot_metodo_D.pdf"
